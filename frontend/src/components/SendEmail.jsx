...
import { setEmails, setOpen } from '../redux/appSlice.js';
  ...
  return (
    <div className={` ${open ? 'block' : 'hidden'} bg-white max-w-6xl shadow-xl shadow-slate-600 rounded-t-md`}>
      ...
      <form onSubmit={submitHandler} className='flex flex-col p-3 gap-2'>
        ...
        <textarea onChange={changeHandler} value={formData.message} name='message' rows={10} cols={30} placeholder='' className='outline-none py-1'></textarea>
